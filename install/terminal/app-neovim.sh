...
wget -O nvim.tar.gz "https://github.com/neovim/neovim/releases/download/stable/nvim-linux-${NVIM_ARCH}.tar.gz"
tar -xf nvim.tar.gz
sudo install nvim-linux-${NVIM_ARCH}/bin/nvim /usr/local/bin/nvim
sudo cp -R nvim-linux-${NVIM_ARCH}/lib /usr/local/
sudo cp -R nvim-linux-${NVIM_ARCH}/share /usr/local/
rm -rf nvim-linux-${NVIM_ARCH} nvim.tar.gz
cd -
